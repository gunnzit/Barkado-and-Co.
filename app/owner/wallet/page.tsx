...
export default async function WalletPage() {
  ...
  return (
    <div className="w-full" style={{ backgroundColor: "var(--cream)", minHeight: "100vh" }}>
      <main className="pb-24 lg:pb-12 max-w-lg lg:max-w-4xl mx-auto">
        ...
        <div className="lg:flex lg:gap-8 lg:items-start lg:px-6">
          {/* Real two-column split from desktop up — balance + earning info
              sticky on the left, everything else on the right. Previously
              identical at every screen width. */}
