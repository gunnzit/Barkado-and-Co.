      ...
      <div className="max-w-lg mx-auto pb-16">
        ...
        {!query && (
          <div className="px-5 space-y-7">
            {/* Recent searches — real, localStorage */}
            {recent.length > 0 && (
              <div>
            ...
            {/* Your Wishlist — real, from useFavorites() */}
            {favorites.length > 0 && (
              <div>
                <h2 className="font-bold text-sm mb-3">Your Wishlist</h2>
            ...
            {/* You might like — existing example/suggestion chips */}
            <div>
              <h2 className="font-bold text-sm mb-3">You might like</h2>
              <div className="flex flex-wrap gap-2">
                {TRENDING.map((t) => (
                  <button
                    key={t}
